 ...
 *
 * Improved by lyfeshoppe for LyfeShoppe Theme
 * Version: 1.3.2
 *
 */
(function($) {
    ...
    jQuery.fn.extend({
        slimScroll: function(options) {
            ...
            var defaults = {
                ...
                // sets animation status on a given scroll(added my lyfeshoppe)
                animate: true
            };
            ...
            this.each(function() {
                ...
                //begin: windows phone fix added by lyfeshoppe
                if ('ontouchstart' in window && window.navigator.msPointerEnabled) {
                  me.css("-ms-touch-action", "none");
              }
                //end: windows phone fix added by lyfeshoppe
