...
from cheermonk.register import (
    api_keys,
    blueprints,
    error_templates,
    exception_handler,
...
from cheermonk.initialize import authentication, locale

CELERY_TASK_LIST = [
    'cheermonk.blueprints.user.tasks',
    'cheermonk.blueprints.issue.tasks',
    'cheermonk.blueprints.billing.tasks',
    'cheermonk.blueprints.stream.tasks',
    'cheermonk.blueprints.admin.tasks',
]
